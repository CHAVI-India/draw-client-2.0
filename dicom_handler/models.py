...
class RTStructureFileImport(models.Model):
    ...
    exported_to_remote_node = models.BooleanField(default=False,help_text="Whether this RT Structure file was exported to a remote DICOM node via C-STORE")
    export_node_name = models.CharField(max_length=256,null=True,blank=True,help_text="Name of the remote node where the RT Structure was exported")
    export_datetime = models.DateTimeField(null=True,blank=True,help_text="Timestamp when the RT Structure was exported to remote node")
